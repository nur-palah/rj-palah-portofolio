...
class KoicaPE extends Component {
    render() {
        const meta = {
            title: 'Koica Web Game | Prosedur Evakuasi',
                        ...
                        <div className="col detail">
                            <Tabs className="detail-page card shadow">
                                ...
                                <TabPanel>
                                    <div id="carouselDetailPage1" className="carousel slide" data-bs-ride="carousel">
                                        <div className="carousel-inner">
                                            <PageCarousel style="carousel-item detail active" img="koica-prosedurevakuasi/prosedur-1" />
                                            <PageCarousel style="carousel-item detail" img="koica-prosedurevakuasi/prosedur-2" />
                                            <PageCarousel style="carousel-item detail" img="koica-prosedurevakuasi/prosedur-3" />
                                            <PageCarousel style="carousel-item detail" img="koica-prosedurevakuasi/prosedur-4" />
                                            <PageCarousel style="carousel-item detail" img="koica-prosedurevakuasi/prosedur-5" />
                                            <PageCarousel style="carousel-item detail" img="koica-prosedurevakuasi/prosedur-6" />
                                        </div>
                                ...
                                <div className="detail-description">
                                    <h2>Koica Web Game | Prosedur Evakuasi</h2>
                                    <p>Url : <a href="">-</a></p>
                                    <p>Back End : Php 8</p>
