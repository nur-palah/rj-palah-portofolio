...
class PalahCo extends Component {
    render() {
        const meta = {
            title: 'Palah.Co',
            description: 'Media providing information needed about the company.',
            meta: {
                charset: 'utf-8',
                name: {
                        ...
                        <div className="col detail">
                            <Tabs className="detail-page card shadow">
                                ...
                                <TabPanel>
                                    <div id="carouselDetailPage1" className="carousel slide" data-bs-ride="carousel">
                                        <div className="carousel-inner">
                                            <PageCarousel style="carousel-item detail active" img="palahco/palahco-1" />
                                            <PageCarousel style="carousel-item detail" img="palahco/palahco-2" />
                                            <PageCarousel style="carousel-item detail" img="palahco/palahco-3" />
                                            <PageCarousel style="carousel-item detail" img="palahco/palahco-4" />
                                            <PageCarousel style="carousel-item detail" img="palahco/palahco-5" />
                                        </div>
                                ...
                                <div className="detail-description">
                                    <h2>Palah.Co</h2>
                                    <p>Url : <a href="https://palah.site/">https://palah.site/</a> <span
